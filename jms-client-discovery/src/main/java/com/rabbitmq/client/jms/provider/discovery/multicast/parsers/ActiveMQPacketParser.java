 ...
 */
package com.rabbitmq.client.jms.provider.discovery.multicast.parsers;

import java.net.URI;
import java.net.URISyntaxException;

import com.rabbitmq.client.jms.provider.discovery.multicast.DiscoveryEvent;
import com.rabbitmq.client.jms.provider.discovery.multicast.DiscoveryEvent.EventType;
import com.rabbitmq.client.jms.provider.discovery.multicast.PacketParser;
