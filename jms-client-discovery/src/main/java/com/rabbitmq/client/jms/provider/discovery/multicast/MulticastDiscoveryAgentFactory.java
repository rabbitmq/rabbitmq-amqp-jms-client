 ...
 */
package com.rabbitmq.client.jms.provider.discovery.multicast;

import java.net.URI;
import java.util.Map;

import com.rabbitmq.client.jms.provider.discovery.DiscoveryAgent;
import com.rabbitmq.client.jms.provider.discovery.DiscoveryAgentFactory;
