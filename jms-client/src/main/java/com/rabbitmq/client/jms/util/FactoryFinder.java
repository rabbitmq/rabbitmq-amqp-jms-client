 ...
 */
package com.rabbitmq.client.jms.util;
...
public class FactoryFinder<T extends Object> {
     ...
     * {@link com.rabbitmq.client.jms.util.FactoryFinder#setObjectFactory(com.rabbitmq.client.jms.util.FactoryFinder.ObjectFactory)}
