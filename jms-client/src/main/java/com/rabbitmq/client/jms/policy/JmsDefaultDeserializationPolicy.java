 ...
 */
package com.rabbitmq.client.jms.policy;
...
public class JmsDefaultDeserializationPolicy implements JmsDeserializationPolicy {
     ...
     */
    @Deprecated
    public static final String DEPRECATED_ALLOWLIST_PROPERTY = "com.rabbitmq.client.jms.deserialization.white_list";

    /**
     * @deprecated new applications should use the DENYLIST_PROPERTY instead
     */
    @Deprecated
    public static final String DEPRECATED_DENYLIST_PROPERTY = "com.rabbitmq.client.jms.deserialization.black_list";

    public static final String ALLOWLIST_PROPERTY = "com.rabbitmq.client.jms.deserialization.allow_list";
    public static final String DENYLIST_PROPERTY = "com.rabbitmq.client.jms.deserialization.deny_list";
