...
import com.rabbitmq.client.jms.jndi.JNDIStorable;
import com.rabbitmq.client.jms.meta.JmsConnectionId;
import com.rabbitmq.client.jms.meta.JmsConnectionInfo;
import com.rabbitmq.client.jms.policy.JmsDefaultDeserializationPolicy;
import com.rabbitmq.client.jms.policy.JmsDefaultMessageIDPolicy;
import com.rabbitmq.client.jms.policy.JmsDefaultPrefetchPolicy;
import com.rabbitmq.client.jms.policy.JmsDefaultPresettlePolicy;
import com.rabbitmq.client.jms.policy.JmsDefaultRedeliveryPolicy;
import com.rabbitmq.client.jms.policy.JmsDeserializationPolicy;
import com.rabbitmq.client.jms.policy.JmsMessageIDPolicy;
import com.rabbitmq.client.jms.policy.JmsPrefetchPolicy;
import com.rabbitmq.client.jms.policy.JmsPresettlePolicy;
import com.rabbitmq.client.jms.policy.JmsRedeliveryPolicy;
import com.rabbitmq.client.jms.provider.Provider;
import com.rabbitmq.client.jms.provider.ProviderFactory;
import com.rabbitmq.client.jms.tracing.JmsNoOpTracer;
import com.rabbitmq.client.jms.tracing.JmsTracer;
import com.rabbitmq.client.jms.tracing.JmsTracerFactory;
import com.rabbitmq.client.jms.util.IdGenerator;
import com.rabbitmq.client.jms.util.PropertyUtil;
import com.rabbitmq.client.jms.util.URISupport;
import com.rabbitmq.client.jms.util.URISupport.CompositeData;
        ...
        synchronized (JmsConnectionFactory.class) {
            ...
            try {
                host = AccessController.doPrivileged(new PrivilegedAction<String>() {
                    @Override
                    public String run() {
                        String result = System.getProperty("com.rabbitmq.client.jms.REMOTE_HOST", DEFAULT_REMOTE_HOST);
                ...
                port = AccessController.doPrivileged(new PrivilegedAction<String>() {
                    @Override
                    public String run() {
                        String result = System.getProperty("com.rabbitmq.client.jms.REMOTE_PORT", DEFAULT_REMOTE_PORT);
            ...
            try {
                remoteAddress = AccessController.doPrivileged(new PrivilegedAction<String>() {
                    @Override
                    public String run() {
                        String result = System.getProperty("com.rabbitmq.client.jms.REMOTE_URI", defaultURL);
