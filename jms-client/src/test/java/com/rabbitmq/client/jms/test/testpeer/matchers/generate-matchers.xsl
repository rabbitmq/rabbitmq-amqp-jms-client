...
import com.rabbitmq.client.jms.test.testpeer.FrameType;
import com.rabbitmq.client.jms.test.testpeer.<xsl:value-of select="$superclass"/>;
...
import org.apache.qpid.proton.amqp.Symbol;
import org.apache.qpid.proton.amqp.UnsignedLong;
import com.rabbitmq.client.jms.test.testpeer.AbstractFieldAndDescriptorMatcher;<xsl:if test="@name != 'accepted' and @name != 'released' and @provides != 'lifetime-policy'">
