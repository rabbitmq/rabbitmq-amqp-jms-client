 ...
 * under the License.
 */
package com.rabbitmq.client.jms.test.testpeer;

import static com.rabbitmq.client.jms.provider.amqp.AmqpSupport.ANONYMOUS_RELAY;
import static com.rabbitmq.client.jms.provider.amqp.AmqpSupport.DELAYED_DELIVERY;
import static com.rabbitmq.client.jms.provider.amqp.AmqpSupport.DYNAMIC_NODE_LIFETIME_POLICY;
import static com.rabbitmq.client.jms.provider.amqp.AmqpSupport.GLOBAL;
import static com.rabbitmq.client.jms.provider.amqp.AmqpSupport.SHARED;
import static com.rabbitmq.client.jms.provider.amqp.AmqpSupport.SHARED_SUBS;
import static com.rabbitmq.client.jms.provider.amqp.AmqpSupport.SOLE_CONNECTION_CAPABILITY;
...
import com.rabbitmq.client.jms.provider.amqp.AmqpSupport;
import com.rabbitmq.client.jms.provider.amqp.message.AmqpDestinationHelper;
import com.rabbitmq.client.jms.test.testpeer.basictypes.AmqpError;
import com.rabbitmq.client.jms.test.testpeer.basictypes.ReceiverSettleMode;
import com.rabbitmq.client.jms.test.testpeer.basictypes.Role;
import com.rabbitmq.client.jms.test.testpeer.basictypes.SenderSettleMode;
import com.rabbitmq.client.jms.test.testpeer.basictypes.StdDistMode;
import com.rabbitmq.client.jms.test.testpeer.basictypes.TerminusDurability;
import com.rabbitmq.client.jms.test.testpeer.basictypes.TerminusExpiryPolicy;
...
import com.rabbitmq.client.jms.test.testpeer.describedtypes.AttachFrame;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.BeginFrame;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.CloseFrame;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.Coordinator;
...
import com.rabbitmq.client.jms.test.testpeer.describedtypes.DetachFrame;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.Discharge;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.DispositionFrame;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.EndFrame;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.FlowFrame;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.FrameDescriptorMapping;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.OpenFrame;
...
import com.rabbitmq.client.jms.test.testpeer.describedtypes.SaslChallengeFrame;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.SaslMechanismsFrame;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.SaslOutcomeFrame;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.Source;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.Target;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.TransferFrame;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.sections.AmqpValueDescribedType;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.sections.ApplicationPropertiesDescribedType;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.sections.HeaderDescribedType;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.sections.MessageAnnotationsDescribedType;
import com.rabbitmq.client.jms.test.testpeer.describedtypes.sections.PropertiesDescribedType;
import com.rabbitmq.client.jms.test.testpeer.matchers.AttachMatcher;
import com.rabbitmq.client.jms.test.testpeer.matchers.BeginMatcher;
import com.rabbitmq.client.jms.test.testpeer.matchers.CloseMatcher;
import com.rabbitmq.client.jms.test.testpeer.matchers.CoordinatorMatcher;
import com.rabbitmq.client.jms.test.testpeer.matchers.DeleteOnCloseMatcher;
import com.rabbitmq.client.jms.test.testpeer.matchers.DetachMatcher;
import com.rabbitmq.client.jms.test.testpeer.matchers.DispositionMatcher;
import com.rabbitmq.client.jms.test.testpeer.matchers.EndMatcher;
import com.rabbitmq.client.jms.test.testpeer.matchers.FlowMatcher;
import com.rabbitmq.client.jms.test.testpeer.matchers.OpenMatcher;
import com.rabbitmq.client.jms.test.testpeer.matchers.SaslInitMatcher;
import com.rabbitmq.client.jms.test.testpeer.matchers.SaslResponseMatcher;
import com.rabbitmq.client.jms.test.testpeer.matchers.SourceMatcher;
import com.rabbitmq.client.jms.test.testpeer.matchers.TargetMatcher;
import com.rabbitmq.client.jms.test.testpeer.matchers.TransferMatcher;
...
public class TestAmqpPeer implements AutoCloseable
{
    ...
    private void expectTempNodeCreationAttach(final String dynamicAddress, final Symbol nodeTypeCapability, boolean sendResponse, final boolean refuseLink, boolean deferAttachResponseWrite, Symbol errorType, String errorMessage)
    {
        ...
        if (sendResponse)
        {
            ...
            if (!refuseLink) {
                ...
                if (errorType != null)
                {
                    com.rabbitmq.client.jms.test.testpeer.describedtypes.Error detachError = new com.rabbitmq.client.jms.test.testpeer.describedtypes.Error();
    ...
    private FrameSender createCloseFrameSender(Symbol errorType, String errorMessage, Map<Symbol, Object> info, final long delayBeforeSend) {
        ...
        if (errorType != null) {
            com.rabbitmq.client.jms.test.testpeer.describedtypes.Error closeError = new com.rabbitmq.client.jms.test.testpeer.describedtypes.Error();
