...
Now you can run the examples using commands of the format:
  ...
  Linux:   java -cp "target/classes/:target/dependency/*" com.rabbitmq.client.jms.example.HelloWorld

  Windows: java -cp "target\classes\;target\dependency\*" com.rabbitmq.client.jms.example.HelloWorld
...
through system properties named USER and PASSWORD respectively. E.g:
  ...
  Linux:   java -DUSER=guest -DPASSWORD=guest -cp "target/classes/:target/dependency/*" com.rabbitmq.client.jms.example.HelloWorld

  Windows: java -DUSER=guest -DPASSWORD=guest -cp "target\classes\;target\dependency\*" com.rabbitmq.client.jms.example.HelloWorld
